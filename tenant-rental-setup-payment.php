...
if ($conn->connect_error) {
  ...
  if (isset($_SESSION['userId'])) {
    ...
    if ($result->num_rows > 0) {
      ...
      $stmt_initial_load = $conn->prepare("SELECT emailAddress, occupiedStall, gcashFile, merchantName, gcashPhoneNumber FROM user_registration WHERE user_registration_id = ?");
