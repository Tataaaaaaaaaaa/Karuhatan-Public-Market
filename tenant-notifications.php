...
<head>
    ...
    <link rel="stylesheet" href="css/tenant-notifications-style.css">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-navbar">
            ...
            echo '<div class="row py-3 align-items-center mb-4" style="box-shadow: 0px 0px 20px #ADB4D6; border-radius: 10px">';
              echo '<div class="col-md-6">';
                ...
                switch ($row["action"]) {
                  ...
                  case 'submitLease':
                    echo '<i class="fa-solid fa-file-circle-check" style="color:#4CD964"></i>&nbsp;&nbsp;&nbsp;Lease Uploaded';
                    break;
                }
                echo '</h3>';
              echo '</div>';
              ...
              echo '<div class="col-md-12 d-flex align-items-center">';
                switch ($row["action"]) {
                  ...
                  case 'submitLease':
                    echo '<h3 class="switzer-medium-text mx-4 display-xsm">Your lease has been uploaded! You can check and download it in the "Document" section</h3>';
                    break;
                }
              echo '</div>';
            echo '</div>';
  ...
  <!-- <div class="container py-3 px-5 mb-1">
    <div class="row py-3 align-items-center" style="box-shadow: 0px 0px 20px #ADB4D6; border-radius: 10px">
        <div class="col-md-6">
            <h3 class="switzer-semibold-text display-0 ms-4"><i class="fa-solid fa-circle-check" style="color: #4CD964"></i>&nbsp;&nbsp;&nbsp;Payment Successful</h3>
        </div>
        ...
        <div class="col-md-12 d-flex align-items-center">
          <h3 class="switzer-medium-text mx-4 display-xsm">Your rental payment has been done successfully. Click to see more details.</h3>
        </div>
    </div>
  </div>
  ...
  <div class="container py-3 px-5 mb-1">
    <div class="row py-3 align-items-center" style="box-shadow: 0px 0px 20px #ADB4D6; border-radius: 10px">
        <div class="col-md-6">
            <h3 class="switzer-semibold-text display-0 ms-4"><i class="fa-solid fa-circle-info" style="color: #283891"></i>&nbsp;&nbsp;&nbsp;Due Payment Reminder</h3>
        </div>
        <div class="col-md-6 d-flex align-items-center res-justify-date">
          <h3 class="switzer-medium-text display-xsm">00:00 AM 00/00/00</h3>
        </div>
        <div class="col-md-12 d-flex align-items-center">
          <h3 class="switzer-medium-text mx-4 display-xsm">Hi, Juan! This is a reminder that your rental payment for 00/00/0000 is approaching its due.</h3>
        </div>
    </div>
  </div>
  ...
  <div class="container py-3 px-5 mb-5">
    <div class="row py-3 align-items-center" style="box-shadow: 0px 0px 20px #ADB4D6; border-radius: 10px">
        <div class="col-md-6">
            <h3 class="switzer-semibold-text display-0 ms-4"><i class="fa-solid fa-circle-xmark" style="color: #FC0E55"></i>&nbsp;&nbsp;&nbsp;Payment Overdue</h3>
        </div>
        <div class="col-md-6 d-flex align-items-center res-justify-date">
          <h3 class="switzer-medium-text display-xsm">00:00 AM 00/00/00</h3>
        </div>
        <div class="col-md-12 d-flex align-items-center">
          <h3 class="switzer-medium-text mx-4 display-xsm">Your rental payment is overdue. Click to see more details.</h3>
        </div>
    </div>
  </div> -->
