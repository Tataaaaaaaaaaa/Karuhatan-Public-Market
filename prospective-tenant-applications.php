...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-navbar">
                ...
                <div class="form-floating mb-5">
                  <select name="preferredStall" class="form-select form-input-style" id="floatingPreferredStall" aria-label="Preferred Category" style="height: 4rem;">
                    ...
                    <optgroup label="Phase 1">
                      ...
                      <option value="P1-7">P1-7</option>
                      <option value="P1-8">P1-8</option>
                      <option value="P1-9">P1-9</option>
                      <option value="P1-10">P1-10</option>
                      <option value="P1-11">P1-11</option>
                      <option value="P1-12">P1-12</option>
                      <option value="P1-13">P1-12</option>
                      <option value="P1-14">P1-14</option>
                      <option value="P1-15">P1-15</option>
                    </optgroup>
                    <optgroup label="Phase 2">
                      <option value="P2-1">P2-1</option>
                      <option value="P2-2">P2-2</option>
                      <option value="P2-3">P2-3</option>
                      <option value="P2-4">P2-4</option>
                      <option value="P2-5">P2-5</option>
                      <option value="P2-6">P2-6</option>
                      <option value="P2-7">P2-7</option>
                      <option value="P2-8">P2-8</option>
                      <option value="P2-9">P2-9</option>
                      <option value="P2-10">P2-10</option>
                      <option value="P2-11">P2-11</option>
                      <option value="P2-12">P2-12</option>
                      <option value="P2-13">P2-12</option>
                      <option value="P2-14">P2-14</option>
                      <option value="P2-15">P2-15</option>
                      <option value="P2-16">P2-16</option>
                      <option value="P2-17">P2-17</option>
                      <option value="P2-18">P2-18</option>
                      <option value="P2-19">P2-19</option>
                      <option value="P2-20">P2-20</option>
                      <option value="P2-21">P2-21</option>
                      <option value="P2-22">P2-22</option>
                      <option value="P2-23">P2-23</option>
                      <option value="P2-24">P2-24</option>
                      <option value="P2-25">P2-25</option>
                      <option value="P2-26">P2-26</option>
                      <option value="P2-27">P2-27</option>
                      <option value="P2-28">P2-28</option>
                      <option value="P2-29">P2-29</option>
                      <option value="P2-30">P2-30</option>
                      <option value="P2-31">P2-31</option>
                      <option value="P2-32">P2-32</option>
                      <option value="P2-33">P2-33</option>
                      <option value="P2-34">P2-34</option>
                      <option value="P2-35">P2-35</option>
                      <option value="P2-36">P2-36</option>
                      <option value="P2-37">P2-37</option>
                      <option value="P2-38">P2-38</option>
                      <option value="P2-39">P2-39</option>
                    </optgroup>
                    <optgroup label="Phase 3">
                      ...
                      <option value="P3-5">P3-5</option>
                      <option value="P3-6">P3-6</option>
                      <option value="P3-7">P3-7</option>
                      <option value="P3-8">P3-8</option>
                      <option value="P3-9">P3-9</option>
                      <option value="P3-10">P3-10</option>
                      <option value="P3-11">P3-11</option>
                      <option value="P3-12">P3-12</option>
                      <option value="P3-13">P3-12</option>
                      <option value="P3-14">P3-14</option>
                      <option value="P3-15">P3-15</option>
                      <option value="P3-16">P3-16</option>
                      <option value="P3-17">P3-17</option>
                      <option value="P3-18">P3-18</option>
                      <option value="P3-19">P3-19</option>
                      <option value="P3-20">P3-20</option>
                      <option value="P3-21">P3-21</option>
                      <option value="P3-22">P3-22</option>
                      <option value="P3-23">P3-23</option>
                      <option value="P3-24">P3-24</option>
                      <option value="P3-25">P3-25</option>
                      <option value="P3-26">P3-26</option>
                      <option value="P3-27">P3-27</option>
                      <option value="P3-28">P3-28</option>
                      <option value="P3-29">P3-29</option>
                      <option value="P3-30">P3-30</option>
                      <option value="P3-31">P3-31</option>
                      <option value="P3-32">P3-32</option>
                      <option value="P3-33">P3-33</option>
                      <option value="P3-34">P3-34</option>
                      <option value="P3-35">P3-35</option>
                    </optgroup>
                    <optgroup label="Phase 4">
                      ...
                      <option value="P4-5">P4-5</option>
                      <option value="P4-6">P4-6</option>
                      <option value="P4-7">P4-7</option>
                      <option value="P4-8">P4-8</option>
                      <option value="P4-9">P4-9</option>
                      <option value="P4-10">P4-10</option>
                      <option value="P4-11">P4-11</option>
                      <option value="P4-12">P4-12</option>
                      <option value="P4-13">P4-12</option>
                      <option value="P4-14">P4-14</option>
                      <option value="P4-15">P4-15</option>
                      <option value="P4-16">P4-16</option>
                      <option value="P4-17">P4-17</option>
                      <option value="P4-18">P4-18</option>
                      <option value="P4-19">P4-19</option>
                      <option value="P4-20">P4-20</option>
                      <option value="P4-21">P4-21</option>
                      <option value="P4-22">P4-22</option>
                      <option value="P4-23">P4-23</option>
                      <option value="P4-24">P4-24</option>
                      <option value="P4-25">P4-25</option>
                      <option value="P4-26">P4-26</option>
                      <option value="P4-27">P4-27</option>
                      <option value="P4-28">P4-28</option>
                      <option value="P4-29">P4-29</option>
                      <option value="P4-30">P4-30</option>
                      <option value="P4-31">P4-31</option>
                      <option value="P4-32">P4-32</option>
                    </optgroup>
                </select>
      ...
      <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-body text-center">
            ...
            <div class="mt-5 py-2">
              <p class="custom-px-4 pb-0 mb-1 switzer-bold-text display-6">Invalid Input</p>
              <h4 class="switzer-medium-text display-sm custom-px-4">Please review your input and try again. Ensure the input fields are filled correctly.</h4>
    ...
    <!-- <div class="modal fade" tabindex="-1" role="dialog" id="duplicateEmailAddressModal">
      <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-body text-center">
            <div>
            ...
            <div class="mt-5 py-2">
              <p class="custom-px-4 pb-0 mb-1 switzer-bold-text display-6">Invalid Submission!</p>
              <h4 class="switzer-medium-text display-sm custom-px-4">You have already submitted a tenant rental application form. Please wait for the approval.</h4>
              <h4 class="switzer-medium-text display-sm custom-px-4" id="dynamicText"></h4>
            </div>
            <div class="py-1">
              <button type="button" class="try-again-button btn btn-lg btn-outline-fail rounded-pill px-5" data-bs-dismiss="modal" style="font-family: 'Switzer-Semibold'">Try Again</button>
