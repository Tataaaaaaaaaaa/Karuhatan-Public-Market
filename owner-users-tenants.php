...
<head>
    ...
    <link rel="stylesheet" href="css/owner-users-tenants-style.css">
                        ...
                        while ($row_tenants = $result_tenants->fetch_assoc()) {
                          ...
                          echo '<td>
                                  <div class="dropdown">
                                      ...
                                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                          <li><a class="dropdown-item switzer-semibold-text" href="owner-users-tenants-view.php?user_registration_id='.$row_tenants["user_registration_id"].'">View</a></li>
                                          <li><a class="dropdown-item switzer-semibold-text" href="owner-users-tenants-lease.php?user_registration_id='.$row_tenants["user_registration_id"].'">Lease</a></li>
                                          <li><a class="dropdown-item switzer-semibold-text toggleDelete" href="" data-bs-toggle="modal" data-bs-target="#deleteModal" data-user-id="'.$row_tenants["user_registration_id"].'">Delete</a></li>
                                      </ul>
                                  </div>
                              </td>';
                        echo '</tr>';
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            confirmDeleteButton.addEventListener('click', function() {
                if (userIdToDelete) {
                    window.location.href = '../Developer things/php/delete-tenant.php?user_id=' + userIdToDelete;
                }
            });
        });
    </script>
