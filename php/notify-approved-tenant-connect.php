    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($conn->connect_error) {
            ...
            if ($result->num_rows == 1) {
                ...
                $mail->isHtml(true);
                $mail->Subject = "Congratulations! Your Application is Approved!";
                $mail->Body = <<<EOD
                <!DOCTYPE html>
                <html lang="en">
                <head>
                ...
                <body>
                    <div class="container">
                        ...
                        <h1>Great News!</h1>
                        <p id="sub-text">Greetings $firstName $lastName, your application to occupy a stall at Karuhatan Public Market has been approved. Welcome to our market community! We're thrilled to have you with us and can't wait to see your stall in action.</p>
