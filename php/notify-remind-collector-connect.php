    ...
    if (isset($_GET['user_registration_id'])) {
        ...
        if ($conn->connect_error) {
            ...
            if ($result_collector_details->num_rows == 1) {
                ...
                $mail->isHtml(true);
                $mail->Subject = "Reminder: Collection of Stall Payments";
                $mail->Body = <<<EOD
                <!DOCTYPE html>
                <html lang="en">
                <head>
                ...
                <body>
                    <div class="container">
                        ...
                        <h1>Reminder</h1>
                        <p id="sub-text">Hi $firstName $lastName, just a quick reminder to collect the stall payments from the tenants at the $occupiedPhase of the Karuhatan Public Market. Your prompt action helps keep everything running smoothly.</p>
                        <p id="sub-text-v2">Thanks for your hard work and dedication!</p>
