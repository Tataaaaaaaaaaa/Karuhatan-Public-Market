...
<head>
    ...
    <link rel="stylesheet" href="css/owner-users-collector-add-style.css">
...
<nav class="navbar navbar-expand-lg-tenant navbar-dark bg-navbar">
    ...
    <div lc-helper="background" class="container-fluid py-0 d-flex justify-content-center" style="  background-image: url('assets/img/about-us-bg.png'); background-position: center; background-size:cover; background-repeat:no-repeat">
      <div class="container-fluid px-4 py-0 my-4 col-8 custom-text-center">
          <h2 class="display-3 switzer-bold-text-white">Add Collector</h2>
      </div>
    </div>
    ...
    <div class="content-md-lg py-3">
                          ...
                          <div class="card-body rounded-0">
                                <div id="AvatarFileUpload">
                                    <div class="selected-image-holder">
                                      <img src="../Developer things/assets/img/default-avatar.png" alt="Avatar">
                                    </div>
                                    <div class="avatar-selector" id="imgUploadBtn" style="cursor: pointer">
      ...
      <div class="row d-flex justify-content-center">
        <div class="col-md-3-1 first-col">
          <div class="form-floating mb-4">
              <input name="firstName" type="text" class="form-control form-input-style" id="firstName" placeholder="" pattern="[\sA-Za-z]+" title="Please enter a valid first name." required autocomplete="off">
              <label for="firstName" class="form-label-style">First Name</label>
          </div>
        </div>
        <div class="col-md-3-1 first-col">
          <div class="form-floating mb-4">
          <input name="middleName" type="text" class="form-control form-input-style" id="middleName" placeholder="" pattern="[\sA-Za-z]+" title="Please enter a valid middle name." required autocomplete="off">
            <label for="middleName" class="form-label-style">Middle Name</label>
          </div>
        </div>
        <div class="col-md-3-1">
          <div class="form-floating mb-4">
            <input name="lastName" type="text" class="form-control form-input-style" id="lastName" placeholder="" pattern="[\sA-Za-z]+" title="Please enter a valid last name." required autocomplete="off">
            <label for="lastName" class="form-label-style">Last Name</label>
          </div>
        </div>
        <div class="col-md-10 first-col">
          <div class="form-floating mb-4">
            <input name="address" type="text" class="form-control form-input-style" id="address" placeholder="" pattern="^[a-zA-Z0-9\s,.'-]{5,}$" title="Please enter your address." required autocomplete="off">
            <label for="address" class="form-label-style">Address</label>
          </div>
        </div>
        <div class="col-md-5 first-col">
          <div class="form-floating mb-4">
            <input name="emailAddress" type="text" class="form-control form-input-style" id="emailAddress" placeholder="" pattern="/^[^\.\s][\w\-\.{2,}]+@([\w-]+\.)+[\w-]{2,}$/gm" title="Please enter a valid email address." required autocomplete="off">
            <label for="emailAddress" class="form-label-style">Email Address</label>
          </div>
        </div>
        <div class="col-md-5">
          <div class="form-floating mb-4">
            <input name="phoneNumber" type="tel" class="form-control form-input-style" id="phoneNumber" placeholder="" pattern="09[0-9]{9}" title="Please enter a valid 11-digit phone number." required autocomplete="off">
            <label for="phoneNumber" class="form-label-style">Phone Number</label>
          </div>
        </div>
        <div class="col-md-5 first-col">
            <div class="form-floating mb-4">
              <input name="password" type="password" class="form-control form-input-style" id="floatingPassword" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\!\#\$\%\&\'\(\)\*\+\,\-\.\/\:\;\<\=\>\?\@\[\\\]\^\_\`\{\|\}\~])[A-Za-z\d\!\#\$\%\&\'\(\)\*\+\,\-\.\/\:\;\<\=\>\?\@\[\\\]\^\_\`\{\|\}\~]{8,}$" title="Password must be at least 8 characters long, contains an uppercase and lowercase letter, a number, and a special character." placeholder="" required>
          ...
          <div class="col-md-5">
            <div class="form-floating mb-4">
              <input name="retypePassword" type="password" class="form-control form-input-style" id="floatingRetypePassword" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\!\#\$\%\&\'\(\)\*\+\,\-\.\/\:\;\<\=\>\?\@\[\\\]\^\_\`\{\|\}\~])[A-Za-z\d\!\#\$\%\&\'\(\)\*\+\,\-\.\/\:\;\<\=\>\?\@\[\\\]\^\_\`\{\|\}\~]{8,}$" title="Please retype your password." placeholder="" required>
      ...
      <div class="col-lg-12 d-flex res-justify-content px-3">
        <button class="px-5 btn btn-lg btn-green mb-2 btn-widen mx-2" id="saveBtn" type="submit">Add</button> 
        <a class="px-5 btn btn-lg btn-red mb-2 btn-widen mx-2" id="cancelBtn">Cancel</a> 
      </div>
    </form>
  </div>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="successModal">
      <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-body text-center">
            ...
            <div class="mt-5 py-2">
              <p class="custom-px-4 pb-0 mb-1 switzer-bold-text display-6">Collector Added</p>
              <h4 class="switzer-medium-text display-sm custom-px-4">Congratulations! You have now added a collector for your phase successfully.</h4>
            </div>
      ...
      <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-body text-center">
            ...
            <div class="mt-5 py-2">
              <p class="custom-px-4 pb-0 mb-1 switzer-bold-text display-6">Action Unsuccessful!</p>
        ...
        <div class="modal-content">
          <div class="modal-body text-center">
            ...
            <div class="mt-5 py-2">
              ...
              <h4 class="switzer-medium-text display-sm custom-px-4">Please select a JPG or PNG file for the collector's avatar.</h4>
            </div>
            <div class="py-1">
              <button type="button" class="try-again-button btn btn-lg btn-outline-fail rounded-pill px-5" data-bs-dismiss="modal" style="font-family: 'Switzer-Semibold'">Try Again</button>
            </div>
    ...
    <script>
      document.getElementById("cancelBtn").addEventListener("click", function() {
        window.location.href = "owner-users-collectors.php";
      });
    </script>
...
<script>
      ...
      function validateProfileForm(){
        if(passwordStatus == true && retypePasswordStatus == true && emailAddressStatus == true && addressStatus == true) {
            return true;
    ...
    <script>
      profileForm.addEventListener("submit", function(event) {
        ...
        xhr.open("POST", "../Developer things/php/owner-users-collectors-add-connect.php", true);
