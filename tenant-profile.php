...
if ($conn->connect_error) {
  ...
  if (isset($_SESSION['userId'])) {
    ...
    if ($result->num_rows > 0) {
      ...
      $stmt_profile = $conn->prepare("SELECT * FROM user_registration WHERE user_registration_id = ?");
      ...
      $stmt_profile_additional->bind_param("i", $userID);
...
<head>
    ...
    <link rel="stylesheet" href="css/tenant-profile-style.css">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-navbar">
    ...
    <div lc-helper="background" class="container-fluid py-0 d-flex justify-content-center" style="  background-image: url('assets/img/about-us-bg.png'); background-position: center; background-size:cover; background-repeat:no-repeat">
      <div class="container-fluid px-4 py-0 my-4 col-8 custom-text-center">
          <h2 class="display-3 switzer-bold-text-white">Profile</h2>
      </div>
  </div>
    ...
    <div class="content-md-lg py-3">
      ...
      <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-5 first-col">
          <div class="form-floating mb-4">
            <input name="emailAddress" type="text" class="form-control form-input-style input-field" id="emailAddress" placeholder="" pattern="/^[^\.\s][\w\-\.{2,}]+@([\w-]+\.)+[\w-]{2,}$/gm" title="Please enter a valid email address." value="<?php echo $emailAddress; ?>" required autocomplete="off" disabled>
        ...
        <div class="modal-content">
          <div class="modal-body text-center">
            ...
            <div class="mt-5 py-2">
              ...
              <h4 class="switzer-medium-text display-sm custom-px-4">Congratulations! Your profile has been updated successfully.</h4>
            </div>
        ...
        <div class="modal-content">
          <div class="modal-body text-center">
            ...
            <div class="mt-5 py-2">
              ...
              <h4 class="switzer-medium-text display-sm custom-px-4">Please select a JPG or PNG file for your avatar.</h4>
            </div>
            <div class="py-1">
              <button type="button" class="try-again-button btn btn-lg btn-outline-fail rounded-pill px-5" data-bs-dismiss="modal" style="font-family: 'Switzer-Semibold'">Try Again</button>
            </div>
        ...
        <div class="modal-content">
          <div class="modal-body text-center">
            ...
            <div class="mt-5 py-2">
              ...
              <h4 class="switzer-medium-text display-sm custom-px-4">Unfortunately we encountered an issue with updating your profile. Please try again later.</h4>
            </div>
            <div class="py-1">
              <button type="button" class="try-again-button btn btn-lg btn-outline-fail rounded-pill px-5" data-bs-dismiss="modal" style="font-family: 'Switzer-Semibold'">Try Again</button>
            </div>
  ...
  <script>
      ...
      document.getElementById("cancelBtn").addEventListener("click", function() {
        ...
        window.location.href = "tenant-profile.php";
      });
    </script>
    ...
    <script>
      profileForm.addEventListener("submit", function(event) {
        ...
        xhr.open("POST", "../Developer things/php/tenant-profile-connect.php", true);
