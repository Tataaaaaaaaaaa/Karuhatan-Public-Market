...
<body>
    ...
    <div lc-helper="background" class="container-fluid py-0 d-flex justify-content-center" style="background-image: url('assets/img/about-us-bg.png'); background-position: center; background-size:cover; background-repeat:no-repeat">
        <div class="container-fluid px-4 py-0 my-4 col-8 custom-text-center">
            <h2 class="display-3 switzer-bold-text-white">My Application</h2>
        </div>
    </div>
          ...
          <form action="" method="POST" id="tenantApplicationForm" onsubmit="return validateTenantApplicationForm()" autocomplete="off">
                ...
                <div class="form-floating mb-5">
                  <select name="preferredStall" class="form-select form-input-style input-field" id="floatingPreferredStall" aria-label="Preferred Category" style="height: 4rem;" disabled>
                    ...
                    <optgroup label="Phase 1">
                      <option value="P1-1" <?php echo ($preferredStall === 'P1-1') ? 'selected' : ''; ?>>Stall 1</option>
                      <option value="P1-2" <?php echo ($preferredStall === 'P1-2') ? 'selected' : ''; ?>>Stall 2</option>
                      <option value="P1-3" <?php echo ($preferredStall === 'P1-3') ? 'selected' : ''; ?>>Stall 3</option>
                      <option value="P1-4" <?php echo ($preferredStall === 'P1-4') ? 'selected' : ''; ?>>Stall 4</option>
                      <option value="P1-5" <?php echo ($preferredStall === 'P1-5') ? 'selected' : ''; ?>>Stall 5</option>
                      <option value="P1-6" <?php echo ($preferredStall === 'P1-6') ? 'selected' : ''; ?>>Stall 6</option>
                      <option value="P1-7" <?php echo ($preferredStall === 'P1-7') ? 'selected' : ''; ?>>Stall 7</option>
                      <option value="P1-8" <?php echo ($preferredStall === 'P1-8') ? 'selected' : ''; ?>>Stall 8</option>
                      <option value="P1-9" <?php echo ($preferredStall === 'P1-9') ? 'selected' : ''; ?>>Stall 9</option>
                      <option value="P1-10" <?php echo ($preferredStall === 'P1-10') ? 'selected' : ''; ?>>Stall 10</option>
                      <option value="P1-11" <?php echo ($preferredStall === 'P1-11') ? 'selected' : ''; ?>>Stall 11</option>
                      <option value="P1-12" <?php echo ($preferredStall === 'P1-12') ? 'selected' : ''; ?>>Stall 12</option>
                      <option value="P1-13" <?php echo ($preferredStall === 'P1-13') ? 'selected' : ''; ?>>Stall 13</option>
                      <option value="P1-14" <?php echo ($preferredStall === 'P1-14') ? 'selected' : ''; ?>>Stall 14</option>
                      <option value="P1-15" <?php echo ($preferredStall === 'P1-15') ? 'selected' : ''; ?>>Stall 15</option>
                    </optgroup>
                    <optgroup label="Phase 2">
                      <option value="P2-1" <?php echo ($preferredStall === 'P2-1') ? 'selected' : ''; ?>>Stall 1</option>
                      <option value="P2-2" <?php echo ($preferredStall === 'P2-2') ? 'selected' : ''; ?>>Stall 2</option>
                      <option value="P2-3" <?php echo ($preferredStall === 'P2-3') ? 'selected' : ''; ?>>Stall 3</option>
                      <option value="P2-4" <?php echo ($preferredStall === 'P2-4') ? 'selected' : ''; ?>>Stall 4</option>
                      <option value="P2-5" <?php echo ($preferredStall === 'P2-5') ? 'selected' : ''; ?>>Stall 5</option>
                      <option value="P2-6" <?php echo ($preferredStall === 'P2-6') ? 'selected' : ''; ?>>Stall 6</option>
                      <option value="P2-7" <?php echo ($preferredStall === 'P2-7') ? 'selected' : ''; ?>>Stall 7</option>
                      <option value="P2-8" <?php echo ($preferredStall === 'P2-8') ? 'selected' : ''; ?>>Stall 8</option>
                      <option value="P2-9" <?php echo ($preferredStall === 'P2-9') ? 'selected' : ''; ?>>Stall 9</option>
                      <option value="P2-10" <?php echo ($preferredStall === 'P2-10') ? 'selected' : ''; ?>>Stall 10</option>
                      <option value="P2-11" <?php echo ($preferredStall === 'P2-11') ? 'selected' : ''; ?>>Stall 11</option>
                      <option value="P2-12" <?php echo ($preferredStall === 'P2-12') ? 'selected' : ''; ?>>Stall 12</option>
                      <option value="P2-13" <?php echo ($preferredStall === 'P2-13') ? 'selected' : ''; ?>>Stall 13</option>
                      <option value="P2-14" <?php echo ($preferredStall === 'P2-14') ? 'selected' : ''; ?>>Stall 14</option>
                      <option value="P2-15" <?php echo ($preferredStall === 'P2-15') ? 'selected' : ''; ?>>Stall 15</option>
                      <option value="P2-16" <?php echo ($preferredStall === 'P2-16') ? 'selected' : ''; ?>>Stall 16</option>
                      <option value="P2-17" <?php echo ($preferredStall === 'P2-17') ? 'selected' : ''; ?>>Stall 17</option>
                      <option value="P2-18" <?php echo ($preferredStall === 'P2-18') ? 'selected' : ''; ?>>Stall 18</option>
                      <option value="P2-19" <?php echo ($preferredStall === 'P2-19') ? 'selected' : ''; ?>>Stall 19</option>
                      <option value="P2-20" <?php echo ($preferredStall === 'P2-20') ? 'selected' : ''; ?>>Stall 20</option>
                      <option value="P2-21" <?php echo ($preferredStall === 'P2-21') ? 'selected' : ''; ?>>Stall 21</option>
                      <option value="P2-22" <?php echo ($preferredStall === 'P2-22') ? 'selected' : ''; ?>>Stall 22</option>
                      <option value="P2-23" <?php echo ($preferredStall === 'P2-23') ? 'selected' : ''; ?>>Stall 23</option>
                      <option value="P2-24" <?php echo ($preferredStall === 'P2-24') ? 'selected' : ''; ?>>Stall 24</option>
                      <option value="P2-25" <?php echo ($preferredStall === 'P2-25') ? 'selected' : ''; ?>>Stall 25</option>
                      <option value="P2-26" <?php echo ($preferredStall === 'P2-26') ? 'selected' : ''; ?>>Stall 26</option>
                      <option value="P2-27" <?php echo ($preferredStall === 'P2-27') ? 'selected' : ''; ?>>Stall 27</option>
                      <option value="P2-28" <?php echo ($preferredStall === 'P2-28') ? 'selected' : ''; ?>>Stall 28</option>
                      <option value="P2-29" <?php echo ($preferredStall === 'P2-29') ? 'selected' : ''; ?>>Stall 29</option>
                      <option value="P2-30" <?php echo ($preferredStall === 'P2-30') ? 'selected' : ''; ?>>Stall 30</option>
                      <option value="P2-31" <?php echo ($preferredStall === 'P2-31') ? 'selected' : ''; ?>>Stall 31</option>
                      <option value="P2-32" <?php echo ($preferredStall === 'P2-32') ? 'selected' : ''; ?>>Stall 32</option>
                      <option value="P2-33" <?php echo ($preferredStall === 'P2-33') ? 'selected' : ''; ?>>Stall 33</option>
                      <option value="P2-34 <?php echo ($preferredStall === 'P2-34') ? 'selected' : ''; ?>">Stall 34</option>
                    </optgroup>
                    <optgroup label="Phase 3">
                      <option value="P3-1" <?php echo ($preferredStall === 'P3-1') ? 'selected' : ''; ?>>Stall 1</option>
                      <option value="P3-2" <?php echo ($preferredStall === 'P3-2') ? 'selected' : ''; ?>>Stall 2</option>
                      <option value="P3-3" <?php echo ($preferredStall === 'P3-3') ? 'selected' : ''; ?>>Stall 3</option>
                      <option value="P3-4" <?php echo ($preferredStall === 'P3-4') ? 'selected' : ''; ?>>Stall 4</option>
                      <option value="P3-5" <?php echo ($preferredStall === 'P3-5') ? 'selected' : ''; ?>>Stall 5</option>
                      <option value="P3-6" <?php echo ($preferredStall === 'P3-6') ? 'selected' : ''; ?>>Stall 6</option>
                      <option value="P3-7" <?php echo ($preferredStall === 'P3-7') ? 'selected' : ''; ?>>Stall 7</option>
                      <option value="P3-8" <?php echo ($preferredStall === 'P3-8') ? 'selected' : ''; ?>>Stall 8</option>
                      <option value="P3-9" <?php echo ($preferredStall === 'P3-9') ? 'selected' : ''; ?>>Stall 9</option>
                      <option value="P3-10" <?php echo ($preferredStall === 'P3-10') ? 'selected' : ''; ?>>Stall 10</option>
                      <option value="P3-11" <?php echo ($preferredStall === 'P3-11') ? 'selected' : ''; ?>>Stall 11</option>
                      <option value="P3-12" <?php echo ($preferredStall === 'P3-12') ? 'selected' : ''; ?>>Stall 12</option>
                      <option value="P3-13" <?php echo ($preferredStall === 'P3-13') ? 'selected' : ''; ?>>Stall 13</option>
                      <option value="P3-14" <?php echo ($preferredStall === 'P3-14') ? 'selected' : ''; ?>>Stall 14</option>
                      <option value="P3-15" <?php echo ($preferredStall === 'P3-15') ? 'selected' : ''; ?>>Stall 15</option>
                      <option value="P3-16" <?php echo ($preferredStall === 'P3-16') ? 'selected' : ''; ?>>Stall 16</option>
                      <option value="P3-17" <?php echo ($preferredStall === 'P3-17') ? 'selected' : ''; ?>>Stall 17</option>
                      <option value="P3-18" <?php echo ($preferredStall === 'P3-18') ? 'selected' : ''; ?>>Stall 18</option>
                      <option value="P3-19" <?php echo ($preferredStall === 'P3-19') ? 'selected' : ''; ?>>Stall 19</option>
                      <option value="P3-20" <?php echo ($preferredStall === 'P3-20') ? 'selected' : ''; ?>>Stall 20</option>
                      <option value="P3-21" <?php echo ($preferredStall === 'P3-21') ? 'selected' : ''; ?>>Stall 21</option>
                      <option value="P3-22" <?php echo ($preferredStall === 'P3-22') ? 'selected' : ''; ?>>Stall 22</option>
                      <option value="P3-23" <?php echo ($preferredStall === 'P3-23') ? 'selected' : ''; ?>>Stall 23</option>
                      <option value="P3-24" <?php echo ($preferredStall === 'P3-24') ? 'selected' : ''; ?>>Stall 24</option>
                      <option value="P3-25" <?php echo ($preferredStall === 'P3-25') ? 'selected' : ''; ?>>Stall 25</option>
                      <option value="P3-26" <?php echo ($preferredStall === 'P3-26') ? 'selected' : ''; ?>>Stall 26</option>
                    </optgroup>
                    <optgroup label="Phase 4">
                      <option value="P4-1" <?php echo ($preferredStall === 'P4-1') ? 'selected' : ''; ?>>Stall 1</option>
                      <option value="P4-2" <?php echo ($preferredStall === 'P4-2') ? 'selected' : ''; ?>>Stall 2</option>
                      <option value="P4-3" <?php echo ($preferredStall === 'P4-3') ? 'selected' : ''; ?>>Stall 3</option>
                      <option value="P4-4" <?php echo ($preferredStall === 'P4-4') ? 'selected' : ''; ?>>Stall 4</option>
                      <option value="P4-5" <?php echo ($preferredStall === 'P4-5') ? 'selected' : ''; ?>>Stall 5</option>
                      <option value="P4-6" <?php echo ($preferredStall === 'P4-6') ? 'selected' : ''; ?>>Stall 6</option>
                      <option value="P4-7" <?php echo ($preferredStall === 'P4-7') ? 'selected' : ''; ?>>Stall 7</option>
                      <option value="P4-8" <?php echo ($preferredStall === 'P4-8') ? 'selected' : ''; ?>>Stall 8</option>
                      <option value="P4-9" <?php echo ($preferredStall === 'P4-9') ? 'selected' : ''; ?>>Stall 9</option>
                      <option value="P4-10" <?php echo ($preferredStall === 'P4-10') ? 'selected' : ''; ?>>Stall 10</option>
                      <option value="P4-11" <?php echo ($preferredStall === 'P4-11') ? 'selected' : ''; ?>>Stall 11</option>
                      <option value="P4-12" <?php echo ($preferredStall === 'P4-12') ? 'selected' : ''; ?>>Stall 12</option>
                      <option value="P4-13" <?php echo ($preferredStall === 'P4-13') ? 'selected' : ''; ?>>Stall 13</option>
                      <option value="P4-14" <?php echo ($preferredStall === 'P4-14') ? 'selected' : ''; ?>>Stall 14</option>
                      <option value="P4-15" <?php echo ($preferredStall === 'P4-15') ? 'selected' : ''; ?>>Stall 15</option>
                      <option value="P4-16" <?php echo ($preferredStall === 'P4-16') ? 'selected' : ''; ?>>Stall 16</option>
                      <option value="P4-17" <?php echo ($preferredStall === 'P4-17') ? 'selected' : ''; ?>>Stall 17</option>
                      <option value="P4-18" <?php echo ($preferredStall === 'P4-18') ? 'selected' : ''; ?>>Stall 18</option>
                      <option value="P4-19" <?php echo ($preferredStall === 'P4-19') ? 'selected' : ''; ?>>Stall 19</option>
                      <option value="P4-20" <?php echo ($preferredStall === 'P4-20') ? 'selected' : ''; ?>>Stall 20</option>
                      <option value="P4-21" <?php echo ($preferredStall === 'P4-21') ? 'selected' : ''; ?>>Stall 21</option>
                      <option value="P4-22" <?php echo ($preferredStall === 'P4-22') ? 'selected' : ''; ?>>Stall 22</option>
                      <option value="P4-23" <?php echo ($preferredStall === 'P4-23') ? 'selected' : ''; ?>>Stall 23</option>
                      <option value="P4-24" <?php echo ($preferredStall === 'P4-24') ? 'selected' : ''; ?>>Stall 24</option>
                      <option value="P4-25" <?php echo ($preferredStall === 'P4-25') ? 'selected' : ''; ?>>Stall 25</option>
                      <option value="P4-26" <?php echo ($preferredStall === 'P4-26') ? 'selected' : ''; ?>>Stall 26</option>
                      <option value="P4-27" <?php echo ($preferredStall === 'P4-27') ? 'selected' : ''; ?>>Stall 27</option>
                      <option value="P4-28" <?php echo ($preferredStall === 'P4-28') ? 'selected' : ''; ?>>Stall 28</option>
                      <option value="P4-29" <?php echo ($preferredStall === 'P4-29') ? 'selected' : ''; ?>>Stall 29</option>
                      <option value="P4-30" <?php echo ($preferredStall === 'P4-30') ? 'selected' : ''; ?>>Stall 30</option>
                      <option value="P4-31" <?php echo ($preferredStall === 'P4-31') ? 'selected' : ''; ?>>Stall 31</option>
                      <option value="P4-32" <?php echo ($preferredStall === 'P4-32') ? 'selected' : ''; ?>>Stall 32</option>
                    </optgroup>
                </select>
            ...
            <?php
              if($applicationStatus == 'Pending') {
                echo '<div class="col-lg-12 d-flex res-justify-content px-3">
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function() {
        ...
        successModal.addEventListener('hidden.bs.modal', function() {
          window.location.href = "tenant-my-applications-view.php?application_id=<?php echo $applicationId; ?>";
        });

        continueButton.addEventListener('click', function() {
          wwindow.location.href = "tenant-my-applications-view.php?application_id=<?php echo $applicationId; ?>";
        });
      });
    </script>
      ...
      document.addEventListener('DOMContentLoaded', function() {
          ...
          confirmDeleteBtn.addEventListener('click', function() {
              ...
              if (applicationIdToDelete) {
                  window.location.href = 'delete-tenant-application-form.php?application_id=' + applicationIdToDelete;
              }
          });
      });
  </script>
