...
<head>
  ...
  <link rel="stylesheet" href="css/prospective-tenant-my-applications-style.css">
            ...
            echo '<div class="row py-3 align-items-center mb-4" style="box-shadow: 0px 0px 20px #ADB4D6; border-radius: 10px">';
              ...
              echo '<div class="col-md-12 d-flex align-items-center justify-content-end mt-3">';
                echo '<div class="d-grid gap-2 d-sm-flex justify-content-sm-end">';
                  echo '<a class="btn btn-signup btn-lg px-5 gap-3 switzer-semibold-text-white mx-4" href="prospective-tenant-my-applications-view.php?application_id='.$row["application_id"].'" role="button">View</a>';
                echo '</div>';
              echo '</div>';
            echo '</div>';
          }
          ...
          echo '<div class="row py-5" style="box-shadow: 0px 0px 20px #ADB4D6; border-radius: 10px">
                  ...
                  <div class="col-md-6 d-flex align-items-center custom-text-center">
                      <div class="d-grid gap-2 d-sm-flex justify-content-sm-end">
                          <a class="btn btn-signup btn-lg px-5 gap-3 switzer-semibold-text-white mx-4" href="prospective-tenant-applications.php" role="button">Apply Now</a>
                      </div>
                  </div>
              </div>';
