...
<head>
    ...
    <link rel="stylesheet" href="css/prospective-tenant-profile-style.css">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-navbar">
    ...
    <script>
      ...
      document.getElementById("cancelBtn").addEventListener("click", function() {
        ...
        window.location.href = "prospective-tenant-profile.php";
      });
    </script>
    ...
    <script>
      profileForm.addEventListener("submit", function(event) {
        ...
        xhr.open("POST", "../Developer things/php/prospective-tenant-profile-connect.php", true);
