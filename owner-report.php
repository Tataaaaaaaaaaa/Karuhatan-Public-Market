...
<head>
    ...
    <link rel="stylesheet" href="css/owner-report-style.css">
                          ...
                          default:
                              ...
                              <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      ...
                                      >View</a></li>
                                      <li>
                                          <a href="paid-cash-connect.php?payment_id='.$row["payment_id"].'" class="dropdown-item switzer-semibold-text">
                                              Paid Cash
                                          </a>
                                      </li>
                                      <li>
                                          <a href="paid-gcash-connect.php?payment_id='.$row["payment_id"].'" class="dropdown-item switzer-semibold-text">
                                              Paid Gcash
                                          </a>
                                      </li>
                                  </ul>
